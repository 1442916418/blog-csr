<template>
  <div class="w-screen h-screen flex flex-col justify-center items-center">
    ...
    >
      ...
      ></path>
      <ellipse cx="157.68" cy="286.11" rx="157.68" ry="19.48" :fill="fillColor"></ellipse>
      <ellipse cx="157.68" cy="286.11" rx="157.68" ry="19.48" fill="url(#linear-gradient)"></ellipse>
      <path
      ...
      ></polygon>
      <rect x="52.64" y="48.4" width="211.71" height="133.37" rx="8.37" :fill="fillColor"></rect>
      <rect x="52.64" y="48.4" width="211.71" height="133.37" rx="8.37" fill="url(#linear-gradient-4)"></rect>
      <rect x="52.64" y="43.05" width="211.71" height="133.37" rx="8.37" :fill="fillColor"></rect>
      <path
      ...
      <path
        ...
        fill="#fff"
      ></path>
      <path d="M218.1,147.38h-4.68v-1.69h11.4v1.69h-4.71v13.7h-2Z" transform="translate(-58.19 0.8)" fill="#fff"></path>
      <path
    ...
    <y-button class="mt-5" @click="router.replace({ path: '/' })">返回首页</y-button>
  </div>
</template>
