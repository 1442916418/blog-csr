<template>
  <button :class="buttonClass" @click="emits('click', $event)"><slot></slot></button>
</template>
...
@layer components {
  .y-button {
    border-width: 1px;
    @apply px-4 py-1 inline-block text-base font-medium text-gray-600 rounded-md bg-white border-solid border-gray-600;
